...
(function() {
  ...
  .controller('leaguesCtrl', function($scope, $rootScope, $stateParams, $state, $log, $localStorage, $location, $http, updateDataUtils, momentService, textManipulator) {
    ...
    $scope.setSelectedLeague = function() {
      ...
      _.some($scope.allLeagues, function(l, index) {
        return l.slug === $stateParams.leagueName && (selectedLeagueIndex = index);
      });
